...
export default function ToolsUsedDropDown({setType}) {
    const countries = ["A2X", "Acquire", "Adobe","Commerce","Algopix","AmaSuite","Amaze","Owl","Amazon Seller Central","AMZ Base"]
    return (
        <View>
            <SelectDropdown
                data={countries}
                ...
                buttonTextStyle={{ color: theme.lightColor.dropDownColor, fontSize: 14, fontFamily: theme.fontFamily.TinosRegular, fontWeight: theme.fontWeight.normal, marginRight: '78%' }}
