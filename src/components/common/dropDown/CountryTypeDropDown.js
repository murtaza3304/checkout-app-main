...
export default function CountryTypeDropDown() {
    const countries = ["Option1", "Option2", "Option3",]
    return (
        <View>
            <SelectDropdown
                data={countries}
                ...
                buttonTextStyle={{ color: theme.lightColor.dropDownColor, fontSize: 14, fontFamily: theme.fontFamily.TinosRegular, fontWeight: theme.fontWeight.normal, marginRight: 59 }}
